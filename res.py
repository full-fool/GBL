...
class UserMain:
    ...
    def main(self):
        ...
        _board = GameBoard(_root, mygame , gobangai)
...
class Gobang:
    ...
    def update(self):
        ...
        while ((t) < (8)):
            a[t]= - (1)
            t = (t) + (1)
        if ((((self.InputPosition[0]) >= (2)) and ((self.SpriteOwnerId[(((self.InputPosition[0]) - (2)) * (self.MapSize[0])) + (self.InputPosition[1])]) == (CurPlayerID))) and ((self.SpriteOwnerId[(((self.InputPosition[0]) - (1)) * (self.MapSize[0])) + (self.InputPosition[1])]) == (self.NextPlayerID))):
            self.SpriteOwnerId[(((self.InputPosition[0]) - (1)) * (self.MapSize[0])) + (self.InputPosition[1])]= - (1)
            a[curr]=(self.InputPosition[0]) - (1)
            a[(curr) + (1)]=self.InputPosition[1]
            curr = (curr) + (2)
        if ((((self.InputPosition[0]) <= ((self.MapSize[0]) - (3))) and ((self.SpriteOwnerId[(((self.InputPosition[0]) + (2)) * (self.MapSize[0])) + (self.InputPosition[1])]) == (CurPlayerID))) and ((self.SpriteOwnerId[(((self.InputPosition[0]) + (1)) * (self.MapSize[0])) + (self.InputPosition[1])]) == (self.NextPlayerID))):
            self.SpriteOwnerId[(((self.InputPosition[0]) + (1)) * (self.MapSize[0])) + (self.InputPosition[1])]= - (1)
            a[curr]=(self.InputPosition[0]) + (1)
            a[(curr) + (1)]=self.InputPosition[1]
            curr = (curr) + (2)
        if ((((self.InputPosition[1]) >= (2)) and ((self.SpriteOwnerId[((self.InputPosition[0]) * (self.MapSize[0])) + ((self.InputPosition[1]) - (2))]) == (CurPlayerID))) and ((self.SpriteOwnerId[((self.InputPosition[0]) * (self.MapSize[0])) + ((self.InputPosition[1]) - (1))]) == (self.NextPlayerID))):
            self.SpriteOwnerId[((self.InputPosition[0]) * (self.MapSize[0])) + ((self.InputPosition[1]) - (1))]= - (1)
            a[curr]=self.InputPosition[0]
            a[(curr) + (1)]=(self.InputPosition[1]) - (1)
            curr = (curr) + (2)
        if ((((self.InputPosition[1]) <= ((self.MapSize[1]) - (3))) and ((self.SpriteOwnerId[((self.InputPosition[0]) * (self.MapSize[0])) + ((self.InputPosition[1]) + (2))]) == (CurPlayerID))) and ((self.SpriteOwnerId[((self.InputPosition[0]) * (self.MapSize[0])) + ((self.InputPosition[1]) + (1))]) == (self.NextPlayerID))):
            self.SpriteOwnerId[((self.InputPosition[0]) * (self.MapSize[0])) + ((self.InputPosition[1]) + (1))]= - (1)
            a[curr]=self.InputPosition[0]
            a[(curr) + (1)]=(self.InputPosition[1]) + (1)
            curr = (curr) + (2)
